...
public class Patient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File file = new File("file1");
        System.out.println("Do you want to delete a file after finishing work?");
        Scanner scanner2 = new Scanner(System.in);
        System.out.print("Enter 1 if you want to delete. Other number if you want to save.");
        int wnt= scanner2.nextInt();
        if (wnt==1) {
            file.deleteOnExit(); //файл удалится после завершения работы виртуальной машины Java
            System.out.println("We deleted everything!");
        }
        else
            System.out.println("We have saved all the data!");
